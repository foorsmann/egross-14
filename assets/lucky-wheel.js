...
async function applyDiscountCode(code) {
  if (code) {
    fetch(`${helpers_WebArcDesignSettings.shop_domain}/discount/${code}`).then(() => {}).catch(() => {});
  }
}
...
/* provided dependency */ var lucky_wheel_WebArcDesignTheme = __webpack_require__(4558)["WebArcDesignTheme"];
/* provided dependency */ var lucky_wheel_WebArcDesignSettings = __webpack_require__(4558)["WebArcDesignSettings"];
...
class LuckyWheel {
  constructor(settings) {
    ...
    (0,defineProperty/* default */.Z)(this, "handleSubmit", async () => {
      ...
      if (validated) {
        ...
        if (res.ok) {
          ...
          this.toggleLoading(false);
          lucky_wheel_WebArcDesignTheme.Notification.show({
    ...
    if (this.settings?.display_on === 'home_only' && lucky_wheel_WebArcDesignSettings.template === 'index') {
      this.init();
    }
